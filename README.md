...
> Additionally, ensure that you have cloned this repository and you are currently in the `hca-translation-demo` folder. This should be your active working directory for the rest of the commands.
...
2. Build and deploy the service to Cloud Run:
   ...
   ```bash
   export SERVICE_NAME='hca-translation-demo' # This is the name of our Application and Cloud Run service. Change it if you'd like.
   ```
